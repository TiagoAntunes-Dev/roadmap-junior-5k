# 🚀 Roadmap do Júnior de 5k: Missão Full Stack

## 🎯 Sobre o Projeto
Este repositório é o meu laboratório de estudos e diário de bordo durante as férias. O objetivo não é apenas colecionar certificados ou copiar tutoriais, mas sim aplicar **engenharia reversa e entender a lógica** por trás das tecnologias que formam um desenvolvedor Full Stack sólido e preparado para o mercado real.

A meta é dominar a base, entender os "porquês" de cada arquitetura e documentar a evolução camada por camada.
...
- [ ] **Style Guide:** Cores, tipografia, espaçamento e a criação dos Design Tokens.
- [ ] **Iconografia:** Uso de grids, bibliotecas e consistência visual.
- [ ] **Construção:** Componentes, Variantes e Auto Layout.
- [ ] **UI/UX:** Hierarquia visual, peso, contraste e respiro nas telas.
- [ ] **O Elo Final:** Como traduzir as propriedades do Figma diretamente para o código.

---
*Construído com lógica, muitos erros de compilação resolvidos e café.* ☕ 
