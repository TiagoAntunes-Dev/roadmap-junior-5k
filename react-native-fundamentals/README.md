...
### Passo 4: Visualizando no seu celular
*   Certifique-se de que o computador e o celular estão conectados à **mesma rede Wi-Fi**.
*   **Android:** Abra o app Expo Go e selecione *Scan QR Code*.
*   **iOS:** Abra o aplicativo de Câmera do iPhone e aponte para o QR Code.
*   Qualquer mudança salva no código (`Ctrl + S`) aparecerá instantaneamente no celular graças ao *Fast Refresh*.